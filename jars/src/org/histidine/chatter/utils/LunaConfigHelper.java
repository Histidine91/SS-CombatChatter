...
public class LunaConfigHelper implements LunaSettingsListener {
    ...
    public static void initLunaConfig() {
		...
		addSetting("floaterFontSize", "integer", Global.getSettings().getFloat("chatter_floaterFontSize"), 12, 48);
    ...
    public static void loadConfigFromLuna() {
		...
		Global.getSettings().setFloat("chatter_floaterFontSize", (float)(int)loadSetting("floaterFontSize", "integer"));
